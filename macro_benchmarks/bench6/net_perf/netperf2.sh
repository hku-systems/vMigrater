...
then
	...
	/usr/bin/taskset -c $2 /usr/bin/netperf -t TCP_STREAM -H 192.168.122.95 -p 12865 -l $3
	echo "============> siege end===============>"
	...
	/usr/bin/taskset -c $2 /usr/bin/netperf -t UDP_STREAM -H 192.168.122.95 -p 12865 -l $3
	#start_ts=$(($(date +%s%N)/1000))
	#/usr/bin/taskset -c 6 /bin/cp /home/kvm1/sda2/testA /home/kvm1/sda3
	#end_ts=$(($(date +%s%N)/1000))
	#let diff_ts=$end_ts-$start_ts
