...
gcc io_mul.c ../debug.c -o 2io -lpthread -lglib-2.0
gcc io_random_mul.c ../debug.c -o 2io_ran -lpthread -lglib-2.0
gcc io_mul_bursty.c ../debug.c -o 2io_bursty -lpthread -lglib-2.0
gcc io_random_mul_bursty.c ../debug.c -o 2io_ran_bursty -lpthread -lglib-2.0
