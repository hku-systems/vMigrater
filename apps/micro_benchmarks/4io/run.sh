...
BIN_DIR=/home/kvm1/vMigrater/apps/micro_benchmarks/4io
BIN_MIGRATER=/home/kvm1/vMigrater/apps/micro_benchmarks/4io/with_migrater
...
$1/umount.sh
$1/mount.sh
$BIN_DIR/4io_seq_bursty 1 1 1 1 >> $2
...
$1/umount.sh
$1/mount.sh
$BIN_DIR/4io_seq_bursty 5 5 5 5 >> $2
...
$1/umount.sh
$1/mount.sh
$BIN_DIR/4io_ran_bursty 1 1 1 1 >> $2
...
$1/umount.sh
$1/mount.sh
$BIN_DIR/4io_ran_bursty 5 5 5 5 >> $2
