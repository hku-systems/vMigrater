...
gcc io_original_mul.c debug.c -o 2io_seq -lpthread -lglib-2.0
gcc io_original_mul_bursty.c debug.c -o 2io_seq_bursty -lpthread -lglib-2.0
gcc io_original_random_mul.c debug.c -o 2io_ran -lpthread -lglib-2.0
gcc io_original_random_mul_bursty.c debug.c -o 2io_ran_bursty -lpthread -lglib-2.0
