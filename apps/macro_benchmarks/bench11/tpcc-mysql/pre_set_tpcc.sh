...
mysql -uroot -p123 tpcc1000 < $TPCC_DIR/create_table.sql
mysql -uroot -p123 tpcc1000 < $TPCC_DIR/add_fkey_idx.sql
$TPCC_DIR/tpcc_load -h127.0.0.1 -dtpcc1000 -uroot -p123 -w 10
